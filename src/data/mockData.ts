...
export const INITIAL_DRIVERS: Driver[] = [
  {
    ...
    isVerified: true,
    kycStatus: 'approved',
    currentLocation: { lat: 9.5620, lng: 44.0645 },
    currentHeading: 45,
    vehicle: {
      model: 'Toyota Vitz',
      color: 'White',
  ...
  },
  {
    ...
    isVerified: true,
    kycStatus: 'approved',
    currentLocation: { lat: 9.5745, lng: 44.0530 },
    currentHeading: 120,
    vehicle: {
      model: 'Toyota Corolla Fielder',
      color: 'White',
      licensePlate: 'SL-7814',
      category: 'wadaage_taxi',
      capacity: 4,
    },
    todayEarnings: 14.00,
    weeklyEarnings: 110.00,
    hoursOnline: 5,
    acceptanceRate: 96,
    service_type: 'Normal',
  },
  {
    ...
    isVerified: true,
    kycStatus: 'approved',
    currentLocation: { lat: 9.5515, lng: 44.0725 },
    currentHeading: 270,
    vehicle: {
      model: 'Toyota Probox',
      color: 'White',
  ...
  },
  {
    ...
    isVerified: true,
    kycStatus: 'approved',
    currentLocation: { lat: 9.5395, lng: 44.0880 },
    currentHeading: 180,
    vehicle: {
      model: 'Toyota Ractis',
      color: 'White',
